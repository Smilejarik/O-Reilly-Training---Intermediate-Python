...
sonnets = open("materials/sonnets.txt").readlines()
word_set = set([elt.strip() for elt in open("materials/sowpods.txt")])
sonnet_words = set()
...
def strip_punctuation(word):
    ...
    if apostrophe_index != -1:
        print("Word is: {}, with apostrophe index {}".format(word, apostrophe_index))
        return None
    return word.strip(string.punctuation)  # remove punctuation around
